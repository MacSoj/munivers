...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "Recuerda que puedes realizar todas tus gestiones aquí ",)));
};
...
const Pin = () => {
    ...
    return (React.createElement("div", { id: "app-pin-wrapper" },
        React.createElement("input", { disabled: userStatus !== UserStatus.LoggingIn && userStatus !== UserStatus.LogInError, id: "app-pin-hidden-input", maxLength: 13, ref: ref, type: "number", value: pin, onChange: handleOnChange }),
        React.createElement("div", { id: "app-pin", onClick: handleOnClick },
            ...
            React.createElement(PinDigit, { focused: pin.length === 6, value: pin[6] }),
            React.createElement(PinDigit, { focused: pin.length === 7, value: pin[7] }),
            React.createElement(PinDigit, { focused: pin.length === 8, value: pin[8] }),
            React.createElement(PinDigit, { focused: pin.length === 9, value: pin[9] }),
            React.createElement(PinDigit, { focused: pin.length === 10, value: pin[10] }),
            React.createElement(PinDigit, { focused: pin.length === 11, value: pin[11] }),
            React.createElement(PinDigit, { focused: pin.length === 12, value: pin[12] }),
            React.createElement(PinDigit, { focused: pin.length === 13, value: pin[13] })),
            
        React.createElement("h3", { id: "app-pin-label" },
            "INGRESE SU DPI (3186801060719) ",
            getErrorText(),
            " ",
            getCancelText())));
};
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "Tus ultimas gestiones" }, getDays()));
};
...
const Tools = () => {
    const getTools = () => {
        return [{
                ...
                id: 1,
                image: "./images/palabra.png",
                name: "Boleto de Ornato"
            }, {
                icon: "fa-sharp fa-regulat fa-coins",
                id: 2,
                image: "./images/impuestos.png",
                name: "Iusi"
            }, {
                icon: "fa-solid fa-siren-on",
                id: 3,
                image: "./images/oficial-de-trafico.png",
                name: "Multas PMT"
            }, {
                icon: "fa-sharp fa-light fa-building-shield",
                id: 4,
                image: "./images/oficina-de-la-policia.png",
                name: "Antecedentes policiacos"
            }, {
                icon: "fa-sharp fa-regular fa-droplet",
                id: 5,
                image: "./images/gota-de-agua.png",
                name: "Pago de agua"
            }].map((tool) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-file", id: "tools-section", title: "Tramites" }, getTools()));
};

const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Conoce quien esta en la municipalidad",
                id: 1,
                image: "./images/multitud.png",
                title: "Consejo municipal"
            }, {
                desc: "Conoce el presupuesto actual en la municipalidad",
                id: 2,
                image: "./images/presupuesto.png",
                title: "Presupuesto activo"
            }, {
                desc: "Conoce las obras en desarollo",
                id: 3,
                image: "./images/trabajo-en-progreso.png",
                title: "Obras en desarollo"
            }, {
                desc: "Ven a visitarnos en estos horarios",
                id: 4,
    ...
    return (React.createElement(MenuSection, { icon: "fa-light fa-circle-info", id: "restaurants-section", title: "Conoce tu muni" }, getRestaurants()));
};

const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "Aquí puedes dar aviso de las siguientes fallas: agua, luz, cableado, etc",
                id: 1,
                icon: "fa-regular fa-house-crack",
                image: "./images/cancelar.png",
                title: "Servicios básicos"
            }, {
                desc: "Aquí puedes dar aviso de las siguientes fallas: accidentes, robos, denuncias.",
                id: 2,
    ...
    return (React.createElement(MenuSection, { icon: "fa-light fa-tty", id: "movies-section", scrollable: true, title: "Sevicio al cliente" }, getMovies()));
};
